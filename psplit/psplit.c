 ...
 *
 * Jose R. Valverde, EMBnet/CNB, CSIC. Aug 2010.
 *	Added support for literal context splitting.
 */
/*
...
static void setbcount(const char *s)
{
    char *x;
...
{
    fprintf(stderr,
	    "Usage: %s [ -b#[k|m] | -Lpattern | -l# | -# ] [ -a# ] [ file [ name ] ]\n",
	    progname);
    exit(2);
}
